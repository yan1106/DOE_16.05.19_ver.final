...
public partial class DOE_yes : System.Web.UI.Page
{
    ...
    public void rec_categorydata()
    {
        ...
        sb.Append("<script>");
        sb.Append("var array_spec_char = new Array;var array_md = new Array;var array_cate = new Array;var array_SpeChar = new Array; var row_count = 0;");
        foreach (string str in str_kp)
        {
            sb.Append("array_spec_char.push(" + str + ");");
        }
